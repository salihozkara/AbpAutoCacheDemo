...
public class AutoCacheDemoDomainSharedModule : AbpModule
{
    public override void PreConfigureServices(ServiceConfigurationContext context)
    {
        AutoCacheDemoGlobalFeatureConfigurator.Configure();
        AutoCacheDemoModuleExtensionConfigurator.Configure();
    }
    ...
    public override void ConfigureServices(ServiceConfigurationContext context)
    {
        ...
        {
            options.FileSets.AddEmbedded<AutoCacheDemoDomainSharedModule>();
        });

        Configure<AbpLocalizationOptions>(options =>
        {
            options.Resources
                .Add<AutoCacheDemoResource>("en")
                .AddBaseTypes(typeof(AbpValidationResource))
                .AddVirtualJson("/Localization/AutoCacheDemo");

            options.DefaultResourceType = typeof(AutoCacheDemoResource);
        ...
        {
            options.MapCodeNamespace("AutoCacheDemo", typeof(AutoCacheDemoResource));
        });
    }
}
