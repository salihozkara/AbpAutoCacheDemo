...
public class AutoCacheDemoDatabaseCheck : IHealthCheck, ITransientDependency
{
    protected readonly IIdentityRoleRepository IdentityRoleRepository;

    public AutoCacheDemoDatabaseCheck(IIdentityRoleRepository identityRoleRepository)
    {
